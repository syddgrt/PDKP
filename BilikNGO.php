...
<html lang="en">
                  ...
                  <div class="row full-height align-items-center">
                    <div class="col-md-12">
                      <ul class="list-unstyled menu">
                        ...
                        <li class="active"><a href="BilikNGO.php">Bilik NGO</a></li>
                      </ul>
                    </div>
  ...
  <div id="booking-modal" class="modal">
   ...
   <div id="admin-login-modal" class="modal">
    ...
    <section class="site-hero overlay page-inside" style="background-image: url(gambarDewan/bilikNGO/bilikNGOMain.jpg)">
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center">
            <h1 class="heading" data-aos="fade-up">Bilik NGO</h1>
            <div class="col-md-12 text-center">
            <p class="sub-heading mb-10" data-aos="fade-up" data-aos-delay="100">Kompleks Pentadbiran Kubang Pasu</p>
            <p data-aos="fade-up" data-aos-delay="100">
            <a href="#" class="btn uppercase btn-primary mr-md-2 mr-0 mb-3 d-sm-inline d-block" onclick="showBookingForm('Bilik NGO')">Tempahan</a>
                        
            <a href="#" class="btn uppercase btn-outline-light d-sm-inline d-block" onclick="openViewBookings('Bilik NGO')">Lihat tempahan</a></p>
          </div>
        </div>
          </div>
        </div>
    ...
    <section class="bg-light">
      <div class="half d-md-flex d-block">
        <div class="image" data-aos="fade" style="background-image: url(gambarDewan/bilikNGO/bilikNGO1.jpg);"></div>
      ...
      <div class="half d-md-flex d-block">
        <div class="image order-2" data-aos="fade"  style="background-image: url(gambarDewan/bilikNGO/bilikNGO2.jpg);"></div>
      ...
      <section class="bg-light">
      <div class="half d-md-flex d-block">
        <div class="image" data-aos="fade" style="background-image: url(gambarDewan/bilikNGO/bilikNGO3.jpg);"></div>
        <div class="text" data-aos="fade-right" data-aos-delay="200">
          <h2>Hubungi Kami</h2>
          ...
          <div class="col-md-12">
            <div class="home-slider major-caousel owl-carousel mb-5" data-aos="fade-up" data-aos-delay="200">
              <div class="slider-item">
                <img src="gambarDewan/bilikNGO/bilikNGOSlider1.jpg" alt="Image placeholder" class="img-fluid">
              </div>
              <div class="slider-item">
                <img src="gambarDewan/bilikNGO/bilikNGOSlider2.jpg" alt="Image placeholder" class="img-fluid">
              </div>
              <div class="slider-item">
                <img src="gambarDewan/bilikNGO/bilikNGOSlider3.jpg" alt="Image placeholder" class="img-fluid">
              </div>
              <div class="slider-item">
                <img src="gambarDewan/bilikNGO/bilikNGOSlider4.jpg" alt="Image placeholder" class="img-fluid">
              </div>
              <div class="slider-item">
                <img src="gambarDewan/bilikNGO/bilikNGOSlider5.jpg" alt="Image placeholder" class="img-fluid">
              </div>
              <div class="slider-item">
                <img src="gambarDewan/bilikNGO/bilikNGOSlider6.jpg" alt="Image placeholder" class="img-fluid">
              </div>
            </div>
            <!-- END slider -->
          </div>
