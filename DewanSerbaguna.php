                  ...
                  <div class="row full-height align-items-center">
                    <div class="col-md-12">
                      <ul class="list-unstyled menu">
                        ...
                        <li class="active"><a href="DewanSerbaguna.php">Dewan Serbaguna</a></li>
   ...
   <div id="admin-login-modal" class="modal">
      ...
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center">
            <h1 class="heading" data-aos="fade-up">Dewan Serbaguna</h1>
            <div class="col-md-12 text-center">
            <p class="sub-heading mb-10" data-aos="fade-up" data-aos-delay="100">Kompleks Pentadbiran Kubang Pasu</p>
            <p data-aos="fade-up" data-aos-delay="100">
            <a href="#" class="btn uppercase btn-primary mr-md-2 mr-0 mb-3 d-sm-inline d-block" onclick="showBookingForm('Dewan Serbaguna')">Tempahan</a>
            


            
            <a href="#" class="btn uppercase btn-outline-light d-sm-inline d-block" onclick="openViewBookings('Dewan Serbaguna')">Lihat tempahan</a></p>
          </div>
        </div>
          </div>
        </div>
    ...
    <section class="bg-light">
      <div class="half d-md-flex d-block">
        <div class="image" data-aos="fade" style="background-image: url('gambarDewan/DewanSerbaguna.jpg');"></div>
      ...
      <div class="half d-md-flex d-block">
        <div class="image order-2" data-aos="fade"  style="background-image: url('gambarDewan/DewanSerbaguna2.jpg');"></div>
      ...
      <section class="bg-light">
      <div class="half d-md-flex d-block">
        <div class="image" data-aos="fade" style="background-image: url('gambarDewan/DewanSerbaguna3.jpg');"></div>
        <div class="text" data-aos="fade-right" data-aos-delay="200">
          <h2>Hubungi Kami</h2>
