                  ...
                  <div class="row full-height align-items-center">
                    <div class="col-md-12">
                      <ul class="list-unstyled menu">
                        ...
                        <li class="active"><a href="DewanKodiang.php">Dewan Kodiang</a></li>
      ...
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center">
            <h1 class="heading" data-aos="fade-up">Dewan Kodiang</h1>
            <div class="col-md-12 text-center">
            <p class="sub-heading mb-10" data-aos="fade-up" data-aos-delay="100">Kompleks Pentadbiran Kubang Pasu</p>
            <p data-aos="fade-up" data-aos-delay="100">
            <a href="#" class="btn uppercase btn-primary mr-md-2 mr-0 mb-3 d-sm-inline d-block" onclick="showBookingForm('Dewan Kodiang')">Tempahan</a>
            


            
            <a href="#" class="btn uppercase btn-outline-light d-sm-inline d-block" onclick="openViewBookings('Dewan Kodiang')">Lihat tempahan</a></p>
          </div>
        </div>
          </div>
        </div>
